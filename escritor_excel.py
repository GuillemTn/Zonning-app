...
def escribir_excel(df, ruta_salida='Zonning_Hoy.xlsx', ruta_horario='Horario semana.xlsx', ruta_plantilla='Plantilla_Visual.xlsx'):
    """
    ...
    """
    grupos_map = _extraer_grupos_por_color(ruta_horario)
...
def generar_salida(empleados_hoy, cuadrante_dict, ruta_salida='Zonning_Hoy.xlsx', ruta_horario='Horario semana.xlsx', ruta_plantilla='Plantilla_Visual.xlsx'):
    """
    ...
    # Escribir a Excel
    return escribir_excel(df, ruta_salida, ruta_horario, ruta_plantilla)
